...
flights_data = spark.read.json(bucket_name+"/"+file_name+".json")
...
output_flight_nums = bucket_name+"/flight_data_output/"+file_name+"_flight_nums"
output_distance_category = bucket_name+"/flight_data_output/"+file_name+"_distance_category"
